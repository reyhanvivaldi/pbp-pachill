...
from wishlist.views import login_user, show_wishlist_ajax
from wishlist.views import logout_user, show_bs
...
urlpatterns = [
    ...
    path('xml/', show_xml, name='show_xml'),    # fungsi name disini buat apa?
